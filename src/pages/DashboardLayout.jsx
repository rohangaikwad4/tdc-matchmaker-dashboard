/**
 * Dashboard layout wrapper with TDC-branded header and logout.
 * Protects child routes — redirects to login if no matchmaker session exists.
 * Uses React Router Outlet to render nested dashboard pages.
 */
...
export default function DashboardLayout() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      {/* TDC-branded header */}
      <header className="tdc-gradient shadow-sm">
